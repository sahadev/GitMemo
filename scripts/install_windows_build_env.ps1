...
Write-Host "Restarting sshd so future remote build sessions pick up PATH changes..."
Restart-Service sshd -ErrorAction SilentlyContinue
Write-Host "Open a new PowerShell or SSH session before building so PATH changes take effect."
