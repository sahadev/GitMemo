    ...
    <section className="py-24 px-6 border-t border-border">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="w-full max-w-6xl mx-auto mb-12">
          <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_auto_minmax(0,1.5fr)_auto_minmax(0,1.35fr)] items-center gap-4 sm:gap-5">
...
function Step({ num, label }: { num: string; label: string }) {
  return (
    <div className="flex w-full min-w-0 flex-col sm:flex-row items-center gap-3 sm:gap-4 rounded-2xl border border-border bg-surface px-5 py-5 sm:px-6 sm:py-6 text-center sm:text-left">
      ...
      <span className="text-text text-sm font-medium leading-6 sm:leading-7 break-words">{label}</span>
    </div>
  )
}

function Arrow() {
  return <span className="hidden sm:flex self-center items-center justify-center text-border text-lg px-1 shrink-0 leading-none">&rarr;</span>
}
