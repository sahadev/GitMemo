    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 hero-grid overflow-hidden">
      ...
      <div className="relative z-10 flex flex-wrap items-center justify-center gap-4 mt-10">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-transparent border border-border text-text font-semibold text-sm hover:border-[rgba(0,122,255,0.4)] hover:text-white transition-colors"
        >
