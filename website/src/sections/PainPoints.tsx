  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-text text-center mb-4">{t('pain.title')}</h2>
          ...
          {problems.map((p, i) => (
            <FadeIn key={p.titleKey} delay={i * 0.1}>
              <div className="glass-card p-8 h-full">
                ...
                <h3 className="text-text font-semibold text-lg mb-3">{t(p.titleKey)}</h3>
