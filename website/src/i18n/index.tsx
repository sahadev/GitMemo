...
const en: Record<string, string> = {
  ...
  // Why AI Era
  'why.label': 'Why GitMemo exists',
  'why.title': 'AI work needs a durable knowledge layer',
  'why.subtitle': 'AI changed not only how people write, but where valuable knowledge is produced and how quickly it disappears. GitMemo turns temporary sources into user-owned knowledge that humans and AI can return to.',
...
const zh: Record<string, string> = {
  ...
  // Why AI Era
  'why.label': '为什么需要 GitMemo',
  'why.title': 'AI 工作需要一个长期知识层',
  'why.subtitle': 'AI 改变的不只是写作方式，也改变了高价值知识产生的位置和消失的速度。GitMemo 把临时来源转成用户自己拥有、可被人和 AI 反复读取的长期知识。',
