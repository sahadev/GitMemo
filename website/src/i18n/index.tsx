...
const en: Record<string, string> = {
  ...
  'feat.notes.desc': 'Create scratch notes and manuals with a fast Markdown editor. Like Obsidian meets Sublime Text — lightweight, Git-native, no subscription.',
  ...
  'capture.notes.desc': 'Scratch notes and technical docs — like Obsidian but Git-native, like Typora but with search',
...
const zh: Record<string, string> = {
  ...
  'feat.notes.desc': '内置快速 Markdown 编辑器，创建便签和技术手册。像 Obsidian 一样管理笔记，像 Sublime/Typora 一样轻快——Git 原生，无订阅费。',
  ...
  'capture.notes': '开发者笔记',
  'capture.notes.desc': '便签和技术手册——像 Obsidian 但 Git 原生，像 Typora 但带搜索',
