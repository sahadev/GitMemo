...
Current source version: v1.0.130
...
- APK URL: https://gitmemo.kakacut.cn/mobile/gitmemo-android-v1.0.130-arm64-v8a-release.apk
- APK filename: gitmemo-android-v1.0.130-arm64-v8a-release.apk
- ABI: arm64-v8a
...
- Windows: setup `.exe` for Windows 10/11 x64.
  ...
  - Versioned filename: gitmemo-windows-v1.0.130-x64-setup.exe
