...
function App() {
  ...
  const pageContent = initialized === false && currentPage !== "settings" ? (
    ...
    <>
      {visitedPages.has("dashboard") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "dashboard" ? "true" : "false"}><DashboardPage onNavigate={navigatePage} active={currentPage === "dashboard"} /></div>}
      {visitedPages.has("ai-records") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "ai-records" ? "true" : "false"}><AiRecordsPage active={currentPage === "ai-records"} onFocusSidebar={focusSidebar} enterTrigger={enterContentTrigger} registerMobileBackHandler={(handler) => registerMobileBackHandler("ai-records", handler)} /></div>}
      {visitedPages.has("notes") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "notes" ? "true" : "false"}><NotesPage active={currentPage === "notes"} focusTrigger={focusTrigger} onFocusSidebar={focusSidebar} enterTrigger={enterContentTrigger} registerMobileBackHandler={(handler) => registerMobileBackHandler("notes", handler)} /></div>}
      {visitedPages.has("clipboard") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "clipboard" ? "true" : "false"}><ClipboardPage active={currentPage === "clipboard"} onNavigate={navigatePage} onFocusSidebar={focusSidebar} enterTrigger={enterContentTrigger} registerMobileBackHandler={(handler) => registerMobileBackHandler("clipboard", handler)} /></div>}
      {isDesktop && visitedPages.has("vault") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "vault" ? "true" : "false"}><VaultPage active={currentPage === "vault"} /></div>}
      {visitedPages.has("favorites") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "favorites" ? "true" : "false"}><FavoritesPage active={currentPage === "favorites"} registerMobileBackHandler={(handler) => registerMobileBackHandler("favorites", handler)} /></div>}
      {isDesktop && visitedPages.has("claude-config") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "claude-config" ? "true" : "false"}><ClaudeConfigPage active={currentPage === "claude-config"} onFocusSidebar={focusSidebar} enterTrigger={enterContentTrigger} /></div>}
      {visitedPages.has("imports") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "imports" ? "true" : "false"}><ImportsPage onFocusSidebar={focusSidebar} enterTrigger={enterContentTrigger} active={currentPage === "imports"} registerMobileBackHandler={(handler) => registerMobileBackHandler("imports", handler)} /></div>}
      {isDesktop && visitedPages.has("editor-home") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "editor-home" ? "true" : "false"}><EditorHomePage active={currentPage === "editor-home"} openTarget={editorOpenTarget} onOpenTargetConsumed={() => setEditorOpenTarget(null)} /></div>}
      {isDesktop && visitedPages.has("external-files") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "external-files" ? "true" : "false"}><ExternalFilesPage active={currentPage === "external-files"} openTarget={externalFileOpenTarget} onOpenTargetConsumed={handleExternalFileTargetConsumed} onImportResult={handleExternalImportResult} /></div>}
      {visitedPages.has("search") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "search" ? "true" : "false"}><SearchPage active={currentPage === "search"} focusTrigger={focusTrigger} entryTrigger={searchEntryTrigger} openFilePath={openFilePath} onFileOpened={() => setOpenFilePath(null)} registerMobileBackHandler={(handler) => registerMobileBackHandler("search", handler)} /></div>}
      {visitedPages.has("settings") && <div className="gm-app-page-mount" data-markdown-visibility-mount="true" data-active={currentPage === "settings" ? "true" : "false"}><SettingsPage onNavigate={navigatePage} active={currentPage === "settings"} /></div>}
    </>
  );
